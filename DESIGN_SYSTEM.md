...
- **Buttons**: Accent Background (#7B8A4B), Primary/White Text.
- **Headers**: Maintain high contrast using the Primary color.
- **Grid**: Clean vertical rhythm with ample whitespace.
- **Consistency**: The same palette and typography are utilized across all digital assets (LinkedIn, GitHub, YouTube).

---

## 5. Digital Strategy & Links

- **Main Hub**: [guetta.tech](https://guetta.tech)
